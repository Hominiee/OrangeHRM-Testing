...
public class TC_FP_003 {
    public static void main(String[] args) throws InterruptedException {
        ...
        try {
            boolean PWchange = driver.findElement(By.xpath("//span[@class='oxd-text oxd-text--span oxd-input-field-error-message oxd-input-group__message']")).isDisplayed();
            Thread.sleep(1000);
